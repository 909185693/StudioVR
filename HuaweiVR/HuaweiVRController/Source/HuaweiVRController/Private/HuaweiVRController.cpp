...
FHuaweiVRController::FHuaweiVRController(const TSharedRef< FGenericApplicationMessageHandler >& InMessageHandler)
	...
	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::Back] = FGamepadKeyNames::MotionController_Right_Shoulder;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::Back] = FGamepadKeyNames::MotionController_Left_Shoulder;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::Confirm] = FGamepadKeyNames::MotionController_Right_FaceButton1;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::Confirm] = FGamepadKeyNames::MotionController_Left_FaceButton1;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::Trigger] = FGamepadKeyNames::MotionController_Right_Trigger;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::Trigger] = FGamepadKeyNames::MotionController_Left_Trigger;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::Trigger6DoF] = FGamepadKeyNames::MotionController_Right_Trigger;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::Trigger6DoF] = FGamepadKeyNames::MotionController_Left_Trigger;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::Grip6DoF] = FGamepadKeyNames::MotionController_Right_Grip1;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::Grip6DoF] = FGamepadKeyNames::MotionController_Left_Grip1;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::AX6DoF] = FGamepadKeyNames::MotionController_Right_FaceButton1;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::AX6DoF] = FGamepadKeyNames::MotionController_Left_FaceButton1;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::BY6DoF] = FGamepadKeyNames::MotionController_Right_Shoulder;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::BY6DoF] = FGamepadKeyNames::MotionController_Left_Shoulder;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::Thumbstick6DoF] = FGamepadKeyNames::MotionController_Right_Thumbstick;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::Thumbstick6DoF] = FGamepadKeyNames::MotionController_Left_Thumbstick;
	...
	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::TouchPadLeft] = FGamepadKeyNames::MotionController_Right_FaceButton2;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::TouchPadLeft] = FGamepadKeyNames::MotionController_Left_FaceButton2;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::TouchPadRight] = FGamepadKeyNames::MotionController_Right_FaceButton3;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::TouchPadRight] = FGamepadKeyNames::MotionController_Left_FaceButton3;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::TouchPadUp] = FGamepadKeyNames::MotionController_Right_FaceButton4;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::TouchPadUp] = FGamepadKeyNames::MotionController_Left_FaceButton4;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::TouchPadDown] = FGamepadKeyNames::MotionController_Right_FaceButton5;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::TouchPadDown] = FGamepadKeyNames::MotionController_Left_FaceButton5;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::TouchPadTouch] = FGamepadKeyNames::MotionController_Right_FaceButton6;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::TouchPadTouch] = FGamepadKeyNames::MotionController_Right_FaceButton6;

	Buttons[(int32)EControllerHand::Right][EHVRControllerButton::TouchPadTouching] = FGamepadKeyNames::MotionController_Right_FaceButton7;
	Buttons[(int32)EControllerHand::Left][EHVRControllerButton::TouchPadTouching] = FGamepadKeyNames::MotionController_Left_FaceButton7;
...
bool FHuaweiVRController::IsRightController() const
{
	bool isRightController = true;
#if HVRCONTROLLER_SUPPORTED_ANDROID_PLATFORMS
	if (NULL != mController) {
		isRightController = mIsRightController;
	}
#endif // HVRCONTROLLER_SUPPORTED_ANDROID_PLATFORMS	
...
void FHuaweiVRController::ProcessControllerButtonEvents()
{
	for (int CIndex = 0; CIndex < 2; CIndex++)
	{
		...
		if (HVR_Android_IsControllerAvailable(mCurrentController))
		{
			...
			if (HVR_Android_IsControllerButtonDown(mCurrentController, ButtonType::ButtonHome) || HVR_Android_IsControllerButtonDown(mCurrentController, ButtonType::ButtonHomeMenu6DoF)) {
				mIsHomePressed = false;
				mIsHomeUp = false;
				mIsCapture = true;
				mIsResetOrientation = true;
			...
			if (HVR_Android_IsControllerButtonPressed(mCurrentController, ButtonType::ButtonHome) || HVR_Android_IsControllerButtonPressed(mCurrentController, ButtonType::ButtonHomeMenu6DoF))
			{
			...
			else if (HVR_Android_IsControllerButtonUp(mCurrentController, ButtonType::ButtonHome) || HVR_Android_IsControllerButtonUp(mCurrentController, ButtonType::ButtonHomeMenu6DoF)) {
			...
			if (CIndex == 0)
			{
				MessageHandler->OnControllerAnalog(FHuaweiVRKeyNames::HuaweiVR_Touch_Left_Thumbstick, 0, IsTouchingTrigger6Dof ? 1.0f : 0.0f);
				MessageHandler->OnControllerAnalog(FHuaweiVRKeyNames::HuaweiVR_Touch_Left_Trigger, 0, IsTouchingThumbstick6DoF ? 1.0f : 0.0f);
			...
			{
				MessageHandler->OnControllerAnalog(FHuaweiVRKeyNames::HuaweiVR_Touch_Right_Thumbstick, 0, IsTouchingTrigger6Dof ? 1.0f : 0.0f);
				MessageHandler->OnControllerAnalog(FHuaweiVRKeyNames::HuaweiVR_Touch_Right_Trigger, 0, IsTouchingThumbstick6DoF ? 1.0f : 0.0f);
