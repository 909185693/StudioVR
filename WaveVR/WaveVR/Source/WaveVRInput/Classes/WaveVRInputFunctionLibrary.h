 ...
 */
UCLASS()
class WAVEVRINPUT_API UWaveVRInputFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(
		BlueprintCallable,
		Category = "WaveVR|Input",
		meta = (ToolTip = "Request Bumper key of the controller or Not. HMD has NO Bumper key."))
	static void RequestBumperInput(EWVR_DeviceType device, bool request);
};
