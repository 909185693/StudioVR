...
void FVRAdapter_Steam::Construction(UObject* Outer, const class FObjectInitializer& ObjectInitializer)
{

}

void FVRAdapter_Steam::Register(AStudioVRPawn* NewPawn)
{
...
void FVRAdapter_Steam::Unregister()
{
	FVRAdapter_Implementation::Unregister();
}

void FVRAdapter_Steam::Tick(float DeltaTime)
{

}

bool FVRAdapter_Steam::PollControllerState(EControllerHand TrackingSource, FVector& Position, FRotator& Orientation)
{
	return false;
}

void FVRAdapter_Steam::AdaptationDisplayComponent(UAdaptiveControllerComponent* AdaptiveControllerComponent)
{

}

uint8 FVRAdapter_Steam::GetDeviceType() const
{
