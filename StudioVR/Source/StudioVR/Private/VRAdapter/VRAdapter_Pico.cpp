...
void FVRAdapter_Pico::Construction(UObject* Outer, const class FObjectInitializer& ObjectInitializer)
{

}

void FVRAdapter_Pico::Register(AStudioVRPawn* NewPawn)
{
...
void FVRAdapter_Pico::Unregister()
{
	FVRAdapter_Implementation::Unregister();
}

void FVRAdapter_Pico::Tick(float DeltaTime)
{

}

bool FVRAdapter_Pico::PollControllerState(EControllerHand TrackingSource, FVector& Position, FRotator& Orientation)
{
	bool bIs6DOF = false;
...
void FVRAdapter_Pico::AdaptationDisplayComponent(UAdaptiveControllerComponent* AdaptiveControllerComponent)
{
...
FVector FVRAdapter_Pico::GetCameraOffset() const
{
